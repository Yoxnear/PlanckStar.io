---
title: Headers
description: Navigation bar selection for minimalist and responsive websites.
sidebar:
  order: 1 
...
import HeaderOne from '../../../components/components/headers/Header1.astro'
import HeaderTwo from '../../../components/components/headers/Header2.astro'
import HeaderThree from '../../../components/components/headers/Header3.astro'
...
<Tabs>
  <TabItem label="Preview">
    <div class="overflow-x-hidden overflow-y-hidden not-content pb-60 md:pb-0">
      <HeaderOne />
    </div>
  </TabItem>
  <TabItem label="Code">
     ```jsx
      <!-- src/components/MinimalHeader.astro -->
      ---
      ...
      >
        <nav class="flex w-full mx-auto justify-between items-center h-16">
          ...
          <a href="/" class="text-lg font-semibold tracking-wide text-white py-2 w-6">
            <Image src={YourLogo} alt="Website main logo" class="w-full fill-tertiary" />
          </a>
...
## 3. Floating Singular Header 

A navigation bar with a logo, navigation links, and social media icons  with a singular touch.

<Tabs>
  <TabItem label="Preview">
    <div class="flex justify-center overflow-x-hidden overflow-y-hidden not-content pb-60 md:pb-0">
        <HeaderThree/>
    </div>
  </TabItem>
  <TabItem label="Code">
